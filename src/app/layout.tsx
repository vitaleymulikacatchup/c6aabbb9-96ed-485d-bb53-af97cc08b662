...
export const metadata: Metadata = {
  title: "Bibito - Music Artist | New Releases & Tours",  description: "Award-winning music artist Bibito. Explore new releases, tour dates, and exclusive content. Stream on all major platforms.",  keywords: "Bibito, music artist, electronic music, new releases, live performances, streaming",  metadataBase: new URL("https://bibito.music"),
  alternates: {
    canonical: "https://bibito.music"
  },
  openGraph: {
    title: "Bibito - Music Artist",    description: "Award-winning music artist crafting bold, innovative sounds. New releases, tour dates & exclusive content.",    url: "https://bibito.music",    siteName: "Bibito",    type: "website",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/vintage-dressed-rocker-playing-electric-guitar_23-2148328610.jpg",        alt: "Bibito Artist Portfolio"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Bibito - Music Artist",    description: "Award-winning music artist. Explore new music, live events & connect with millions of fans.",    images: ["https://img.b2bpic.net/free-photo/vintage-dressed-rocker-playing-electric-guitar_23-2148328610.jpg"]
  },
  robots: {
    index: true,
    follow: true
